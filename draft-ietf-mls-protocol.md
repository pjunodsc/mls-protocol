...
provide some public information about a client.  ClientInitKey
...
before the new client is added. The sender of the Welcome message can
...
from the directory for the client to be added, and encoding it into an
Add message.
